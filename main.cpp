...
int main() {
    ...
    Matrix matrix2(size1, 2);
    Matrix matrix3(size2, 2);
    Matrix matrix4(size2, 2);
    std::cout<<"Stworzone losowo wypelnione macierze o wielkosciach "<< size1<<", "<< size1<<", "<<size2<<", "<<size2<<":\n"<<matrix1<<"\n"<<matrix2<<"\n"<<matrix3<<"\n"<<matrix4;
